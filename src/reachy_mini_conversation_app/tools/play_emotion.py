...
_INTENT_TO_MOVES: dict[str, tuple[str, ...]] = {
    "happy": ("laughing2", "laughing1", "loving1"),
    "excited": ("success2", "dance3", "dance2"),
    "loving": ("loving1", "grateful1"),
    "grateful": ("grateful1", "helpful1", "loving1"),
    "proud": ("success1", "success2"),
    "success": ("success1", "success2"),
    "curious": ("thoughtful1", "attentive1"),
    "inquiring": ("thoughtful1", "attentive1"),
