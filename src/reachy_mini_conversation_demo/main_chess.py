            ...
            await conn.session.update(
                session={
                    ...
                    "instructions": f"""
                        ...
                        We are going to play an act where we're friends playing chess. It's semi scripted so that it flows better.
                        Me: Let's GO!
                        you: I'm ready!
                        Me: Let's play chess!
                        you: but... you lose EVERYTIME
                        
                        And then we'll play the game following the moves below EXACTLY:
                    ...
                    """,
                        ...
                        #                     We're going to play with a lot of banter in between the moves. You will ALWAYS start by playing an emotion then immediately playing your move (by saying the move), then find some sharp banter to say.
