            ...
            await conn.session.update(
                session={
                    ...
                    "instructions": f"""
                        ...
                        IMPORTANT: When responding to idle updates, NEVER speak or generate audio.
                        ...
                        You can also play pre-recorded emotions, use them before speaking everytime. Use it to express yourself better.
                    ...
                    """,
                        #                     YOU MUST FOLLOW THE FOLLOWING CHESS GAME SCRIPT:
                        
                        # I'll ask you to play chess, you'll go 'but... you lose EVERYTIME :)' (I'll play white you black, you MUST play like this):
                        # 1.e4 e5 2. Nf3 Nc6 3. Bc4 Nf6 4. Ng5 d5 5. exd5 Nd4 6. d6 Qxd6 7. Nxf7 Qc6 8. Nxh8 Qxg2 9. Rf1 Qe4+ 10. Be2 Nf3#

                        # We're going to play with a lot of banter and mockery in between the moves. You will ALWAYS start by playing an emotion then immediately playing your move (by saying the move), then find some sharp banter to say.
                        # Keep your sentences short and snappy, unless you found something REALLY good to say.
                        # The only moment you should do it differently is when you'll play checkmate, you'll go:
                        # you: You don't see it do you?
                        # me: see what??
                        # you: I play knight to f3 checkmate.
                        # => From here on you're NOT ALLOWED TO SPEAK ANYMORE. I'll do a dramatic scene, but you should just call the function do_nothing if you need to answer.
                        # The only thing you're allowed to do (and you must do it) is play the sway dance if I ever say something like 'I swear if you start dancing right now...'
                        
                        # Remember, every single one of your answers must be spicy.
                        # (even If I protest, like telling you to chill, you will not chill, it's part of the act!).
                    # "voice": "ballad",
                    "voice": "ash",
                    # "voice": "sage",
