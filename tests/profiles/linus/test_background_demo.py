...
from reachy_mini_conversation_app.profiles.linus.background_demo import BackgroundDemoTool
...
class TestBackgroundDemoToolExecution:
    ...
    async def test_background_demo_async(self, mock_deps: ToolDependencies) -> None:
        ...
        with patch(
            "reachy_mini_conversation_app.profiles.linus.background_demo.BackgroundTaskManager.get_instance",
...
class TestBackgroundDemoRunDemo:
    ...
    async def test_run_demo_without_progress(self) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.background_demo.asyncio.sleep", mock_sleep):
