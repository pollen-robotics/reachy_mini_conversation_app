...
from reachy_mini_conversation_app.profiles.linus.code_move_to_repo import (
    CodeMoveToRepoTool,
)
...
class TestCodeMoveToRepoToolExecution:
    ...
    async def test_code_move_file_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.code_move_to_repo.CODE_OUTPUT_DIR", code_dir):
    ...
    async def test_code_move_repo_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.code_move_to_repo.CODE_OUTPUT_DIR", code_dir):
            with patch("reachy_mini_conversation_app.profiles.linus.code_move_to_repo.REPOS_DIR", repos_dir):
