...
from reachy_mini_conversation_app.profiles.linus.execute_code import (
    CODE_OUTPUT_DIR,
    ALLOWED_EXTENSIONS,
    MAX_EXECUTION_TIME,
    ExecuteCodeTool,
...
class TestExecuteCodeToolExecution:
    ...
    async def test_execute_code_file_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.execute_code.CODE_OUTPUT_DIR", tmp_path / "reachy_code"):
    ...
    async def test_execute_code_disallowed_extension(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.execute_code.CODE_OUTPUT_DIR", code_dir):
