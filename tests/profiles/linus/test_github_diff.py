...
from reachy_mini_conversation_app.profiles.linus.github_diff import GitHubDiffTool
...
class TestGitHubDiffToolExecution:
    ...
    async def test_github_diff_repo_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_diff.REPOS_DIR", repos_dir):
    ...
    async def test_github_diff_not_git_repo(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_diff.REPOS_DIR", repos_dir):
            with patch("reachy_mini_conversation_app.profiles.linus.github_diff.Repo") as mock_repo:
    ...
    async def test_github_diff_unstaged_default(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_diff.REPOS_DIR", repos_dir):
            with patch("reachy_mini_conversation_app.profiles.linus.github_diff.Repo", return_value=mock_repo):
