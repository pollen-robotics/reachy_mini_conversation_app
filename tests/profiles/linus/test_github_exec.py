...
from reachy_mini_conversation_app.profiles.linus.github_exec import (
    ALLOWED_COMMANDS,
    BLOCKED_PATTERNS,
    GitHubExecTool,
)
...
class TestGitHubExecToolExecution:
    ...
    async def test_github_exec_repo_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_exec.REPOS_DIR", repos_dir):
