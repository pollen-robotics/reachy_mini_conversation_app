...
from reachy_mini_conversation_app.profiles.linus.github_update_issue import GitHubUpdateIssueTool
...
class TestGitHubUpdateIssueToolExecution:
    ...
    async def test_github_update_issue_no_token(self, mock_deps: ToolDependencies) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_update_issue.config") as mock_config:
    ...
    async def test_github_update_issue_no_changes(self, mock_deps: ToolDependencies) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_update_issue.config") as mock_config:
            mock_config.GITHUB_TOKEN = "test-token"
            with patch("reachy_mini_conversation_app.profiles.linus.github_update_issue.Github", return_value=mock_github):
