...
from reachy_mini_conversation_app.profiles.linus.github_write_file import GitHubWriteFileTool
...
class TestGitHubWriteFileToolExecution:
    ...
    async def test_github_write_file_repo_not_found(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.profiles.linus.github_write_file.REPOS_DIR", repos_dir):
