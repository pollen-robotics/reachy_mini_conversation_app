...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, "hf-cached", None, None, {"Authorization": "Bearer hf-cached"}, "hf-cached", {}),
        (None, None, None, None, None, "DUMMY", {}),
        (None, None, None, TimeoutError("status unavailable"), None, "DUMMY", {}),
    ],
)
@pytest.mark.asyncio
