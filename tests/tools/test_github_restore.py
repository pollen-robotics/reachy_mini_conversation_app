...
from reachy_mini_conversation_app.tools.github_restore import GitHubRestoreTool, REPOS_DIR
...
class TestGitHubRestoreToolExecution:
    ...
    async def test_github_restore_not_git_repo(self, mock_deps: ToolDependencies, tmp_path: Path) -> None:
        ...
        with patch("reachy_mini_conversation_app.tools.github_restore.REPOS_DIR", repos_dir):
            with patch("reachy_mini_conversation_app.tools.github_restore.Repo") as mock_repo:
